...
$res = mysqli_query($conn,"SELECT * FROM blogs inner join blog_category on blogs.blog_category = blog_category.cat_id WHERE blog_status = 1")
                                ...
                                <?php  
                                    ...
                                    while($row = mysqli_fetch_assoc($res)){
                                        ...
                                        <div class="col-md-4">
                                            <div class="post-media">
                                                <a href="tech-single.html" title="">
                                                    <img src="../'.$row["blog_image"].'" alt="" class="img-fluid">
                                        ...
                                        <div class="blog-meta big-meta col-md-8">
                                            <h4><a href="tech-single.html" title="">'.$row["blog_name"].'</a></h4>
                                            <p>'.$row["blog_content"].'</p>
                                            <small class="firstsmall"><a class="bg-orange" href="tech-category-01.html" title="">'.$row["cat_name"].'</a></small>
                                            <small><a href="tech-single.html" title="">'.$row["blog_publish_date"].'</a></small>
                                            <small><a href="tech-author.html" title="">by '.$row["blog_author_name"].'</a></small>
